...
DROP TABLE IF EXISTS `fish_2d85ad6af6`.`projects`;
DROP TABLE IF EXISTS `fish_2d85ad6af6`.`companies`;
DROP TABLE IF EXISTS `fish_2d85ad6af6`.`categories`;
DROP TABLE IF EXISTS `fish_2d85ad6af6`.`reviewers`;
DROP TABLE IF EXISTS `fish_2d85ad6af6`.`experts`;
DROP TABLE IF EXISTS `fish_2d85ad6af6`.`personas`;
DROP TABLE IF EXISTS `fish_2d85ad6af6`.`locations`;
DROP TABLE IF EXISTS `fish_2d85ad6af6`.`emails`;
DROP TABLE IF EXISTS `fish_2d85ad6af6`.`receivers`;
DROP TABLE IF EXISTS `fish_2d85ad6af6`.`addresses`;
DROP TABLE IF EXISTS `fish_2d85ad6af6`.`items`;
DROP TABLE IF EXISTS `fish_2d85ad6af6`.`orders`;
DROP TABLE IF EXISTS `fish_2d85ad6af6`.`sales`;
DROP TABLE IF EXISTS `fish_2d85ad6af6`.`shipping_types`;
DROP TABLE IF EXISTS `fish_2d85ad6af6`.`shippings`;
DROP TABLE IF EXISTS `fish_2d85ad6af6`.`statuses`;
DROP TABLE IF EXISTS `fish_2d85ad6af6`.`sub_categories`;
DROP TABLE IF EXISTS `fish_2d85ad6af6`.`uploads`;


CREATE TABLE `fish_2d85ad6af6`.`projects` (
...
CREATE TABLE `fish_2d85ad6af6`.`companies` (
	`id` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE `fish_2d85ad6af6`.`categories` (
	`id` int(11) NOT NULL AUTO_INCREMENT,
	`name` varchar(255) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`description` varchar(255) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`created` datetime NOT NULL,
...
CREATE TABLE `fish_2d85ad6af6`.`reviewers` (
	`id` int(11) NOT NULL AUTO_INCREMENT,
	`name` varchar(255) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`created` datetime NOT NULL,
	`modified` datetime NOT NULL,	PRIMARY KEY  (`id`)) 	DEFAULT CHARSET=latin1,
...
CREATE TABLE `fish_2d85ad6af6`.`experts` (
	`id` int(11) NOT NULL AUTO_INCREMENT,
	`name` varchar(255) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`created` datetime NOT NULL,
	`modified` datetime NOT NULL,	PRIMARY KEY  (`id`)) 	DEFAULT CHARSET=latin1,
...
CREATE TABLE `fish_2d85ad6af6`.`personas` (
	`id` int(11) NOT NULL AUTO_INCREMENT,
	`name` varchar(255) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`description` varchar(255) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`created` datetime NOT NULL,
...
CREATE TABLE `fish_2d85ad6af6`.`locations` (
	`id` int(11) NOT NULL AUTO_INCREMENT,
	`name` varchar(255) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`created` datetime NOT NULL,
	`modified` datetime NOT NULL,	PRIMARY KEY  (`id`)) 	DEFAULT CHARSET=latin1,
...
CREATE TABLE `fish_2d85ad6af6`.`emails` (
	`id` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE `fish_2d85ad6af6`.`receivers` (
	`id` int(11) NOT NULL AUTO_INCREMENT,
	`name` varchar(255) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`description` varchar(255) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`created` datetime NOT NULL,
...
CREATE TABLE `fish_2d85ad6af6`.`addresses` (
	`id` int(11) NOT NULL AUTO_INCREMENT,
	`name_line` varchar(255) CHARACTER SET latin1 COLLATE latin1_swedish_ci DEFAULT NULL,
...
CREATE TABLE `fish_2d85ad6af6`.`items` (
	`id` int(11) NOT NULL AUTO_INCREMENT,
	`category_id` int(11) NOT NULL,
...
CREATE TABLE `fish_2d85ad6af6`.`orders` (
	`id` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE `fish_2d85ad6af6`.`sales` (
	`id` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE `fish_2d85ad6af6`.`shipping_types` (
	`id` int(11) NOT NULL AUTO_INCREMENT,
	`name` varchar(255) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`created` datetime NOT NULL,
	`modified` datetime NOT NULL,	PRIMARY KEY  (`id`)) 	DEFAULT CHARSET=latin1,
...
CREATE TABLE `fish_2d85ad6af6`.`shippings` (
	`id` int(11) NOT NULL AUTO_INCREMENT,
	`name` varchar(255) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`price_dollars` float NOT NULL,
...
CREATE TABLE `fish_2d85ad6af6`.`statuses` (
	`id` int(11) NOT NULL AUTO_INCREMENT,
	`name` varchar(255) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`created` datetime NOT NULL,
	`modified` datetime NOT NULL,	PRIMARY KEY  (`id`)) 	DEFAULT CHARSET=latin1,
...
CREATE TABLE `fish_2d85ad6af6`.`sub_categories` (
	`id` int(11) NOT NULL AUTO_INCREMENT,
	`category_id` int(11) NOT NULL,
	`name` varchar(255) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
	`created` datetime NOT NULL,
...
CREATE TABLE `fish_2d85ad6af6`.`uploads` (
	`id` int(11) NOT NULL AUTO_INCREMENT,
	`item_id` int(11) NOT NULL,
	`name` varchar(255) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
