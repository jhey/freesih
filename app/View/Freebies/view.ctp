...
<!--
	<div id="sidebar" class="col-sm-3">
		...
		<div class="actions">
			...
			<ul class="list-group">			
						<li class="list-group-item"><?php echo $this->Html->link(__('Edit Freeby'), array('action' => 'edit', $freeby['Freeby']['id']), array('class' => '')); ?> </li>
		<li class="list-group-item"><?php echo $this->Form->postLink(__('Delete Freeby'), array('action' => 'delete', $freeby['Freeby']['id']), array('class' => ''), __('Are you sure you want to delete # %s?', $freeby['Freeby']['id'])); ?> </li>
		<li class="list-group-item"><?php echo $this->Html->link(__('List Freebies'), array('action' => 'index'), array('class' => '')); ?> </li>
